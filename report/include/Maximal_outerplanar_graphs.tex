...
\begin{figure}[H]
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[page=1,width=0.7\linewidth]{graphics/maximal_outerplanar_example_drawings.pdf}
	\end{subfigure}
	\caption{A straight-line drawing of a maximal outerplanar graph $G'$ with $T'$ out of its tree decomposition}
\end{figure}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{After drawing vertex $5$, the subtree of minimal height is a serialization of vertex $6$ and $7$ and alternates between two layers}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}{\textwidth}
		...
		\includegraphics[page=7,width=0.7\linewidth]{graphics/maximal_outerplanar_example_drawings.pdf}
	\end{subfigure}
	\caption{Alternate box drawing of example illustrated at \ref{im:example_drawing_box_G}}
\end{figure}